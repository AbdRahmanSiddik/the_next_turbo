  ...
  <div class="min-vh-100 d-flex flex-column bg_cover">
      ...
      <div class="container-fluid">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-6">
            <div id="social">
              <ul>
                <li><a href="https://chat.whatsapp.com/FzGfohdbwD440ySxs2D9A1" target="_blank"><i class="bi bi-chat-dots"></i></a></li>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNav">
      ...
      <div class="offcanvas-body">
        <ul>
          <li><a href="/home" class="animated_link">List Pendaftar</a></li>
        </ul>
        <hr>
        <ul>
