...
<body>
  ...
  <div class="card">
    <div class="card-header">
        <h1>Pendaftaran Diterima untuk {{ $detail->nama }}</h1>
    </div>
    <div class="card-body">
        <p>Pendaftaran dengan Kode <strong class="text-primary bg-warning">{{ $detail->token_registrasi }}</strong> telah <strong>Diterima</strong> atau <strong>Lolos</strong></p>
